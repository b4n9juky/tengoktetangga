            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <form method="post" action="{{route('tema.store')}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_tema" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Isi nama tema kuisioner">
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700">Deskripsi</label>
                        <textarea name="deskripsi" id="catatan_tambahan" rows="3" placeholder="Isi Deskripsi yang sesuai dengan tema kuisioner"
