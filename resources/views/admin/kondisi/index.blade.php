        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between">
                <a href="{{ route('kondisi.create') }}"
                    ...
                    <i data-feather="plus-circle" class="mr-2 w-4 h-4"></i> Tambah Kondisi Teramati
                </a>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gradient-to-r from-blue-500 to-violet-500 text-white text-xs uppercase tracking-wider">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left">Jenis Kondisi</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                                ...
                                <td class="px-4 py-3 text-center space-x-2">
                                    <a href="{{ route('kondisi.edit', $row->id) }}"
                                    ...
                                    <form action="{{ route('kondisi.destroy', $row->id) }}" method="POST"
